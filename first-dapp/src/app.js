...
// Contract is our usable abstraction, which we'll use through the code below.
var Contract = contract(coin_artifacts);
...
window.App = {
  start: function() {
    ...
    web3.eth.getAccounts(function(err, accs) {
      ...
      web3.eth.getBalance(account, balance => console.log('balance: '+balance));
      // console.log('balance: '+web3.utils.fromWei(web3.eth.getBalance(account), "ether").valueOf());
      self.refreshBalance();
    });
  },
  ...
  refreshBalance: function() {
    ...
    Contract.deployed().then(function(instance) {
      meta = instance;
      return meta.balances.call(account, {from: account});
    }).then(function(value) {
  ...
  sendCoin: function() {
    ...
    Contract.deployed().then(function(instance) {
      meta = instance;
      return meta.send(receiver, amount, {from: account});
    }).then(function() {
